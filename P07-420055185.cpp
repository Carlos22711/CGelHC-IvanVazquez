...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/*spotLights[2].SetFlash(glm::vec3(-2.0 + mainWindow.getmuevex(), 1.0f, 0.5f), glm::vec3(-1.0f, 0.0f, 0.0f));*/
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-4.4f, -2.35f, -4.0f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.8f, -2.35f, -4.0f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-4.4f, -2.35f, 6.3f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		llanta_der.RenderModel();  // se muestra llanta vista derecha
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.7f, -2.35f, 6.3f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		llanta_izq.RenderModel(); // se muestra llanta vista izquierda
