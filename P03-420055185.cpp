...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/*//CODIGO PARA OBTENER LA CASA EN 3D
		// PISO
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -2.6f, 1.0f));
		model = glm::scale(model, glm::vec3(15.0f, 0.1f, 15.0f));
		...
		//TECHO
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 4.02f, 0.0f));
		model = glm::scale(model, glm::vec3(7.0f, 3.0f, 6.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0, -1.6f, 2.5f));
		model = glm::scale(model, glm::vec3(1.3f, 1.8f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-5.0, -2.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(1.2f, 1.2f, 0.4f));
		...
		//CARA DERECHA VENTANAS

		//Ventana izquierda
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.8, 1.0f, -1.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangularw
		...
		*/
		...
		//Rotaciones de pirámide
		model = glm::scale(model, glm::vec3(0.6f, 0.87f, 0.6f));
		...
		//rotado 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.35f,0.9f, -3.755f));
		//Rotaciones de pirámide
		
		model = glm::scale(model, glm::vec3(0.9f, 0.96f, 0.9f));
		...
		//rotado 2
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.0f, 0.9f, -2.75f));
		//Rotaciones de pirámide
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.35f, 2.2, -3.15f));
		model = glm::scale(model, glm::vec3(0.9f, 0.96f, 0.9f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(230.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.6f, 0.87f, 0.6f));
		...
		//rotado 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.2f, 1.15f, -2.8));
		//Rotaciones de pirámides
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	
		model = glm::scale(model, glm::vec3(0.7f, 0.99f, 0.7f));
		...
		//rotado 2
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.4f, 1.14f, -3.75f));
		//Rotaciones de pirámides
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));

		model = glm::scale(model, glm::vec3(0.7f, 0.99f, 0.75f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));  //Rota sobre el eje x
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f)); //Rota sobre el eje z
		...
		//rotado 3
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.5f, 2.4f, -3.2f));
		//Rotaciones de pirámides
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		//Rotaciones de pirámides
		model = glm::scale(model, glm::vec3(0.55f, 0.77f, 0.55f));
		...
		//Rotaciones de pirámides
		model = glm::scale(model, glm::vec3(0.5f, 0.77f, 0.5f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, -1.0f));
