...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux2(1.0); //Se crea esta variable auxiliar 2 para iniciaizar una nueva matriz que nos lleve al origen
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//CREACION DE ARAÑA ROBOT, PATA ARTICULADA
		//Cuerpo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));
